...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "ujs6eQXHAu6RLiDvAvom";
	private final static String CLIENT_SECRET = "NdKEq2eJbV";
	private final static String REDIRECT_URI = "http://localhost:8181/oauth/naver";
	...
	//간단히 말하면 네이버 로그인 클릭했을 때 어디로 가는지에 대한url설정 by재진 
