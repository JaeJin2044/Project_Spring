...
<%@ page import="com.java.webproject.model.PageVO"%>
	...
	<div class="container">
		...
		<div class="content-category">
			<div class="content-category__item">
				<a href="/main/home?m_category=1">한식</a>
			</div>
			<div class="content-category__item">
				<a href="/main/home?m_category=2">양식</a>
			</div>
			<div class="content-category__item">
				<a href="/main/home?m_category=3">중식</a>
			</div>
			<div class="content-category__item">
				<a href="/main/home?m_category=4">일식</a>
			</div>
			<div class="content-category__item">
				<a href="/main/home?m_category=5">분식</a>
			</div>
			<div class="content-category__item">
				<a href="/main/home?m_category=6">카페/디저트</a>
			</div>
		</div>
		<div class="content">
						...
						<div class="content-list__text">
							<h1 class="text_title">
								...
								<div class="rating__score">
									${item.m_starPoint} <i class="fas fa-star"></i>
								</div>
								<!-- 찜하기버튼 추가 -->
						...
						<li class="main-review-item">
							...
							<div class="more_info">
								<div class="more_info__wrap">
									<a href="/main/detail?m_pk=${item.m_pk}">더보기</a> <a
										href="/main/detail?m_pk=${item.m_pk}"><i
		...
		<div class="paging">
			<div class="paging-wrapper">
				<c:if test="${page.startPage != 1 && page.startPage > 0}">
					<a
						href="/main/home?&searchText=${page.searchText}&page=${page.startPage-1}&m_category=${page.m_category}">
					...
					<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
						<c:choose>
							<c:when test="${i == page.page}">
								<a style="color: teal;">${i}</a>
							</c:when>
							<c:when test="${i != page.page }">
								<a
									href="/main/home?&searchText=${page.searchText}&page=${i}&m_category=${page.m_category}">${i}</a>
							</c:when>
						</c:choose>
					</c:forEach>
				</c:if>
				<c:if test="${page.endPage != page.lastPage}">
					<a
						href="/main/home?&searchText=${page.searchText}&page=${page.endPage+1}&m_category=${page.m_category}">
